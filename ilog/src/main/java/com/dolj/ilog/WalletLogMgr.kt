 ...
 * 添加命名控件
 */
fun WalletLogMgr.iLog(logEntity: LogEntity) {
    WalletLogMgr.write(logEntity)
}
...
object WalletLogMgr {
    ...
    fun init(application: Application, sendUrl: String) {
        ...
        CrashHandlerUtil.instance.init(application)
    }
    ...
    fun s() {
        ...
        if (!map.isNullOrEmpty()) {
            Logan.s(
                ...
                Log.d(ContentValues.TAG, "upload result, httpCode: $statusCode, details: $resultData")
